...
import { LayoutDashboard, FilePlus, BookOpen, Users, BarChart3, LogOut, Shield, Star, Menu, X, ListTodo, FileText } from 'lucide-react';
...
const AdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { icon: <FileText size={20} />, label: 'Instructions', path: '/admin/instructions' },
